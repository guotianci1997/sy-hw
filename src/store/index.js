...
const store = new Vuex.Store({
    ...
    mutations:{
        goshopping(state,item){
            /* state.shoplist.push(state.cartlist[index])
            console.log(state.shoplist);
            state.totalPrice=state.Totalcartnum*state.cartlist[index].price
        ...
        minus(state,index){
            ...
            // state.totalPrice=state.Totalcartnum*state.cartlist[state.listindex].price
        },
        plus(state,index){
            state.shoplist[index].cartnum++;
